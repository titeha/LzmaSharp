...
/// </summary>
/// <remarks>
/// Класс разбит на partial-файлы по областям: основной путь и маршрутизация — здесь,
/// LZMA2-writer — в <c>SevenZipArchiveWriter.Lzma2.cs</c>, Copy-writer — в
/// <c>SevenZipArchiveWriter.Copy.cs</c>, запись FilesInfo — в
/// <c>SevenZipArchiveWriter.FilesInfo.cs</c>, валидация входа и низкоуровневые примитивы —
/// в <c>SevenZipArchiveWriter.Validation.cs</c> и <c>SevenZipArchiveWriter.Primitives.cs</c>.
/// </remarks>
public static partial class SevenZipArchiveWriter
{
  ...
  /// <summary>
  /// Строит 7z-архив для поддерживаемого набора элементов (без сжатия, метод `Copy`).
  /// </summary>
      ...
      out byte[] archive)
  {
    ...
    // Если файловых данных нет, метод сжатия не имеет значения: пишем empty-entry архив.
