...
- Отдельный член **любого размера** (в т.ч. >2 ГиБ) — извлечение, создание и **шифрование** идут
  потоком (потоковый Deflate + потоковый WinZip-AES CTR/HMAC, ZIP64-размеры при ≥4 ГиБ), без
  удержания файла в памяти.
