...
public sealed class SevenZipArchiveDecoderExtractArchiveInternalPathConflictsTests
{
  public static IEnumerable<object[]> InvalidArchiveInternalPathPairs()
  {
    yield return ["dir", "dir/file.bin"];
    yield return ["dir/file.bin", "dir"];
  }

  [Theory]
  [MemberData(nameof(InvalidArchiveInternalPathPairs))]
  public void ExtractToDirectory_ArchiveContainsFilePathThatIsParentOfAnotherEntry_InvalidData_AndNothingExtracted(
      string fileName1,
      string fileName2)
  {
    ...
    string root = Path.Combine(
        Path.GetTempPath(),
        "LzmaSharpTests",
        nameof(SevenZipArchiveDecoderExtractArchiveInternalPathConflictsTests),
