...
public sealed class SevenZipReal7zBcjX86DeflateHeaderNotEncodedTests
{
  [Fact]
  public void DecodeToArray_Real7z_BcjX86_Deflate_HeaderNotEncoded_Ok()
  {
    byte[] archive = ReadTestDataBytes("TestData/Real/bcj_x86_deflate_mhc_off.7z");
