...
public sealed class SevenZipReal7zDelta4Bzip2Tests
{
  [Fact]
  public void DecodeToArray_Real7z_Delta4_BZip2_Ok()
  {
    byte[] archive = ReadTestDataBytes("TestData/Real/delta4_bzip2_mhc.7z");
