...
public sealed class SevenZipReal7zDeflateSolidMultiFileTests
{
  [Fact]
  public void DecodeToArray_Real7z_Deflate_Solid_EmptyFile_Ok()
  {
    byte[] archive = ReadTestDataBytes("TestData/Real/solid_a_empty_b_deflate_mhc.7z");

    // Проверим, что в folder реально Deflate.
