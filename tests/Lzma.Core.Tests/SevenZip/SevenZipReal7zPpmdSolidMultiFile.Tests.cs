...
public sealed class SevenZipReal7zPpmdSolidMultiFileTests
{
  [Fact]
  public void DecodeToArray_Real7z_Ppmd_Solid_EmptyFile_Ok()
  {
    byte[] archive = ReadTestDataBytes("TestData/Real/solid_a_empty_b_ppmd_mhc.7z");

    // Проверим, что в folder реально PPMd.
