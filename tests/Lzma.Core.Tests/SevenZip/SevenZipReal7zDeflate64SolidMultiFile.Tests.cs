...
public sealed class SevenZipReal7zDeflate64SolidMultiFileTests
{
  [Fact]
  public void DecodeToArray_Real7z_Deflate64_Solid_EmptyFile_Ok()
  {
    byte[] archive = ReadTestDataBytes("TestData/Real/solid_a_empty_b_deflate64_mhc.7z");
