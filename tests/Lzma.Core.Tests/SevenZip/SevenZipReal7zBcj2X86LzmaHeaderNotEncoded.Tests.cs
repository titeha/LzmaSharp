...
public sealed class SevenZipReal7zBcj2X86LzmaHeaderNotEncodedTests
{
  [Fact]
  public void DecodeToArray_Real7z_7Zip_Bcj2_X86_Lzma_HeaderNotEncoded_Ok()
  {
    byte[] archive = ReadTestDataBytes("TestData/Real/bcj2_x86_lzma_d1m_mhc_off.7z");
