...
public sealed class SevenZipReal7zBcjX86PpmdHeaderNotEncodedTests
{
  [Fact]
  public void DecodeToArray_Real7z_BcjX86_PPMd_HeaderNotEncoded_Ok()
  {
    ...
    Assert.Single(files);
    Assert.Equal("x86_ppmd.bin", files[0].Name.Replace('\\', '/'));
