...
public sealed class SevenZipReal7zDeflate64HeaderNotEncodedTests
{
  [Fact]
  public void DecodeToArray_Real7z_Deflate64_HeaderNotEncoded_Ok()
  {
    byte[] archive = ReadTestDataBytes("../TestData/Real/deflate64_singlefile_mhc_off.7z");
