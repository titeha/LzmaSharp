...
public sealed class SevenZipReal7zLzma2SolidMultiFileHeaderNotEncodedTests
{
  [Fact]
  public void DecodeToArray_Real7z_Lzma2_Solid_HeaderNotEncoded_Ok()
  {
    ...
    Assert.False(IsLzma(folder.Coders[0].MethodId));
