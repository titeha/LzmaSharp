...
public sealed class SevenZipReal7zBcjX86Lzma2HeaderNotEncodedTests
{
  [Fact]
  public void DecodeToArray_Real7z_BcjX86_Lzma2_HeaderNotEncoded_Ok()
  {
    byte[] archive = ReadTestDataBytes("../TestData/Real/bcj_x86_lzma2_d1m_mhc_off.7z");
