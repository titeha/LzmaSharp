...
public sealed class SevenZipReal7zBcjX86Deflate64Tests
{
  [Fact]
  public void DecodeToArray_Real7z_7Zip_BcjX86_Deflate64_Ok()
  {
    byte[] archive = ReadTestDataBytes("../TestData/Real/bcj_x86_deflate64_mhc.7z");
    ...
    Assert.Single(files);
    Assert.EndsWith("x86_deflate64.bin", files[0].Name, StringComparison.Ordinal);
