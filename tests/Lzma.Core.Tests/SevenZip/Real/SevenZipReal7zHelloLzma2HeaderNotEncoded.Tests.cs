...
public sealed class SevenZipReal7zHelloLzma2HeaderNotEncodedTests
{
  [Fact]
  public void DecodeToArray_Real7z_Lzma2_HeaderNotEncoded_Ok()
  {
    byte[] archive = ReadTestDataBytes("../TestData/Real/hello_lzma2_d1m_mhc_off.7z");
