...
public sealed class SevenZipReal7zDeflateSolidMultiFileHeaderNotEncodedTests
{
  [Fact]
  public void DecodeToArray_Real7z_Deflate_Solid_HeaderNotEncoded_Ok()
  {
    byte[] archive = ReadTestDataBytes("../TestData/Real/solid_a_empty_b_deflate_mhc_off.7z");
