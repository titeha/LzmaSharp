...
public sealed class SevenZipReal7zBcj2X86LzmaSolidMultiFileHeaderNotEncodedTests
{
  [Fact]
  public void DecodeToArray_Real7z_7Zip_Bcj2_X86_Lzma_Solid_HeaderNotEncoded_Ok()
  {
    byte[] archive = ReadTestDataBytes("../TestData/Real/bcj2_solid_a_empty_b_lzma_d1m_mhc_off.7z");
