...
public sealed class SevenZipReal7zBcjX86DeflateTests
{
  [Fact]
  public void DecodeToArray_Real7z_7Zip_BcjX86_Deflate_Ok()
  {
    byte[] archive = ReadTestDataBytes("../TestData/Real/bcj_x86_deflate_mhc.7z");

    // 1) Проверяем, что в header реально есть BCJ + Deflate
    // (а не “случайно без фильтра”).
