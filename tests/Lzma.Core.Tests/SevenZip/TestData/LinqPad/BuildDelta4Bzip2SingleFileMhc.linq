...
void Main()
{
	...
	string archivePath = Path.Combine(outputDir, "delta4_bzip2_mhc.7z");

	string workDir = Path.Combine(Path.GetTempPath(), "LzmaSharp_Delta4_BZip2_" + Guid.NewGuid().ToString("N"));
