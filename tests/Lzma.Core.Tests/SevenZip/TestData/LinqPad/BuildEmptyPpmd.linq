...
void Main()
{
	...
	string archivePath = Path.Combine(outputDir, "solid_a_empty_b_ppmd_mhc.7z");

	string workDir = Path.Combine(
		Path.GetTempPath(),
		"LzmaSharp_PPMd_Solid_" + Guid.NewGuid().ToString("N"));
	...
	try
	{
		...
		// PPMd (7z): MethodId {03 04 01}. :contentReference[oaicite:2]{index=2}
