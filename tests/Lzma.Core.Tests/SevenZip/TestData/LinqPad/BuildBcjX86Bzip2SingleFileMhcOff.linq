...
void Main()
{
	...
	string archivePath = Path.Combine(outputDir, "bcj_x86_bzip2_mhc_off.7z");

	string workDir = Path.Combine(
		Path.GetTempPath(),
		"LzmaSharp_BCJx86_BZip2_Single_NoHeader_" + Guid.NewGuid().ToString("N"));
