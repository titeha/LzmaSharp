...
void Main()
{
	...
	string archivePath = Path.Combine(outputDir, "bcj2_x86_lzma_d1m_mhc.7z");

	string workDir = Path.Combine(
		Path.GetTempPath(),
		"LzmaSharp_BCJ2_X86_LZMA_Single_" + Guid.NewGuid().ToString("N"));
	...
	try
	{
		...
		// BCJ2 + 3 LZMA producer-coder'а, как в официальном примере 7-Zip.
