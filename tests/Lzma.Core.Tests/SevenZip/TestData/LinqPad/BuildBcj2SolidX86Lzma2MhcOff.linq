...
void Main()
{
	...
	string archivePath = Path.Combine(outputDir, "bcj2_solid_a_empty_b_lzma2_d1m_mhc_off.7z");

	string workDir = Path.Combine(
		Path.GetTempPath(),
		"LzmaSharp_BCJ2_Solid_X86_LZMA2_NoHeader_" + Guid.NewGuid().ToString("N"));
	...
	try
	{
		...
		// BCJ2 + 3 LZMA2 producer-coder'а.
		psi.ArgumentList.Add("-m0=BCJ2");
		psi.ArgumentList.Add("-m1=LZMA2:d=1m");
		psi.ArgumentList.Add("-m2=LZMA2:d=64k");
		psi.ArgumentList.Add("-m3=LZMA2:d=64k");
