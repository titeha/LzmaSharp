...
// tests/Lzma.Core.Tests/SevenZip/TestData/Real/aes_lzma2_solid_multifile_pwd_mhe_on.7z
//
// Назначение:
// реальный solid 7z AES-архив с зашифрованным header,
// несколько файлов, LZMA2, пароль LzmaSharp-AES-Stage15.
//
// Используется тестом:
// SevenZipReal7zAesLzma2SolidMultiFileEncryptedHeaderTests
...
void Main()
{
	...
	string workDir = Path.Combine(
		Path.GetTempPath(),
		"LzmaSharpAesLzma2SolidMultiFileEncryptedHeaderRealArchive",
	...
	try
	{
		string archivePath = Path.Combine(realDir, "aes_lzma2_solid_multifile_pwd_mhe_on.7z");
