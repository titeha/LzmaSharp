...
void Main()
{
	...
	string archivePath = Path.Combine(outputDir, "bcj_x86_lzma2_d1m_mhc_off.7z");

	string workDir = Path.Combine(
		Path.GetTempPath(),
		"LzmaSharp_BCJx86_LZMA2_Single_NoHeader_" + Guid.NewGuid().ToString("N"));
