...
public sealed class SevenZipReal7zBcj2X86LzmaSolidMultiFileTests
{
  [Fact]
  public void DecodeToArray_Real7z_7Zip_Bcj2_X86_Lzma_Solid_EmptyFile_Ok()
  {
    byte[] archive = ReadTestDataBytes("TestData/Real/bcj2_solid_a_empty_b_lzma_d1m_mhc.7z");
